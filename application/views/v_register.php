                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-7">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="<?=base_url('register/create');?>" method="post">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user"
                                                placeholder="Nama Lengkap" name="nama_lengkap" autofocus required>
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user"
                                                placeholder="Username [minimal 6 karakter]" name="username" required>
                                            <span class="text-danger"
                                                style="font-size:9pt;"><?= form_error('username'); ?></span>
                                        </div>
                                        <div class="form-group">
                                            <input type="password" class="form-control form-control-user"
                                                placeholder="Password [minimal 6 karakter]" name="password" required>
                                            <span class="text-danger"
                                                style="font-size:9pt;"><?= form_error('password'); ?></span>
                                        </div>
                                        <p>
